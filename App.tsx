    ...
    <div className="shell">
      ...
      <main className="grid">
            ...
            <article className="line-item">
              ...
              <div className="actions-row" style={{ marginTop: '0.5rem' }}>
                <input
                  ...
                  style={{ flex: 1, minHeight: 44, padding: '0.75rem 1rem', borderRadius: 999, border: '1px solid rgba(0,0,0,.15)' }}
                  disabled={lookupBusy}
                />
        ...
        {activeCase && activeTab === 'graph' && (
          <section className="panel full">
            <h2>Relationships & correlation</h2>
            <button
        ...
        {activeTab === 'framework' && (
          <section className="panel full">
            <h2>OSINT Framework directory</h2>
            <p className="muted">
            ...
            <button className="action" onClick={() => void loadFramework()} disabled={frameworkLoading}>
              {frameworkLoading ? 'Loading…' : 'Load catalog'}
            </button>
            ...
            {framework && (
              <>
                ...
                <input
                  ...
                  style={{ width: '100%', minHeight: 44, margin: '0.75rem 0', padding: '0.75rem 1rem', borderRadius: 12, border: '1px solid rgba(0,0,0,.15)' }}
                />
